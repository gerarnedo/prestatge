...
App d'una sola pàgina per catalogar els llibres (escanejant l'ISBN o a mà) i saber en quin nivell i posició de la prestatgeria van, segons tres regles: mida (gran / mitjà / petit) → gènere → alfabètic.
